...
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `baovetaikhoan` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '[]';
...
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `dailyGift` text NOT NULL;
...
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `data_achievement` text NOT NULL;
...
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `data_duahau_egg` text NOT NULL;
...
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `data_luyentap` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;
...
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `giftcode` text NOT NULL;
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `items_daban` text NOT NULL;
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `lasttimepkcommeson` bigint(20) NOT NULL DEFAULT 0;
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `masterDoesNotAttack` text NOT NULL;
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `nhanthoivang` varchar(200) NOT NULL DEFAULT '[]';
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `nhiem_vu_kol` text NOT NULL;
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `notify` text CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `pet` text NOT NULL;
...
ALTER TABLE `player` ADD COLUMN IF NOT EXISTS `total_damage_maydam` bigint(20) NOT NULL;
