...
public class DataGame {
    ...
    private static final String MOUNT_NUM = "733:1,734:2,735:3,743:4,744:5,746:6,795:7,849:8,897:9,920:10,1092:11,1135:12,1148:13,1176:14,2113:15,2110:16";
    public static final Map MAP_MOUNT_NUM = new HashMap();

    private static final byte[] dart = FileIO.readFile("resources/data_game/update_data/dart");
    private static final byte[] arrow = FileIO.readFile("resources/data_game/update_data/arrow");
    private static final byte[] effect = FileIO.readFile("resources/data_game/update_data/effect");
    private static final byte[] image = FileIO.readFile("resources/data_game/update_data/image");
    private static final byte[] skill = FileIO.readFile("resources/data_game/update_data/skill");
    ...
    public static void sendDataImageVersion(Session session) {
        ...
        try {
            msg = new Message(-111);
            msg.writer().write(FileIO.readFile("resources/data_game/data_img_version/x" + session.zoomLevel + "/img_version"));
            session.doSendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
            Log.error(DataGame.class, e);
    ...
    public static void sendTileSetInfo(Session session) {
        ...
        try {
            msg = new Message(-82);
            msg.writer().write(FileIO.readFile("resources/data_game/map/tile_set_info"));
            session.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
        }
