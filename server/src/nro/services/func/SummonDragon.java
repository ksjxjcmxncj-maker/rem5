                ...
                switch (this.select) {
                    case 0:
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            ctGohan.itemOptions.add(new ItemOption(50, Util.nextInt(5, 20)));
                            ctGohan.itemOptions.add(new ItemOption(77, Util.nextInt(5, 20)));
                            ctGohan.itemOptions.add(new ItemOption(103, Util.nextInt(5, 20)));
                            ctGohan.itemOptions.add(new ItemOption(5, Util.nextInt(5, 20)));
                            ctGohan.itemOptions.add(new ItemOption(47, Util.nextInt(1, 3)));

                            ctGohan.itemOptions.add(new ItemOption(93, 7));
                    ...
                    case 1:
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            ctBiden.itemOptions.add(new ItemOption(50, Util.nextInt(5, 20)));
                            ctBiden.itemOptions.add(new ItemOption(77, Util.nextInt(20, 20)));
                            ctBiden.itemOptions.add(new ItemOption(103, Util.nextInt(20, 20)));
                            ctBiden.itemOptions.add(new ItemOption(5, Util.nextInt(20, 20)));
                            ctBiden.itemOptions.add(new ItemOption(47, Util.nextInt(5, 15)));

                            ctBiden.itemOptions.add(new ItemOption(93, 7));
                    ...
                    case 2:
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            ctConuong.itemOptions.add(new ItemOption(50, Util.nextInt(5, 20)));
                            ctConuong.itemOptions.add(new ItemOption(77, Util.nextInt(5, 20)));
                            ctConuong.itemOptions.add(new ItemOption(103, Util.nextInt(5, 20)));
                            ctConuong.itemOptions.add(new ItemOption(5, Util.nextInt(5, 20)));
                            ctConuong.itemOptions.add(new ItemOption(47, Util.nextInt(5, 15)));

                            ctConuong.itemOptions.add(new ItemOption(93, 7));
