...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến"
            + "\bNgười nào tìm thấy và giữ được Ngọc Rồng Sao Đen sẽ mang phần thưởng về cho bang của mình trong vòng 1 ngày\n"
            + "Lưu ý mỗi bang có thể chiếm hữu nhiều viên khác nhau\b"
            + "nhưng nếu cùng loại cũng chỉ nhận được 1 lần phần thưởng đó."
            + "\b Có 2 cách để thắng:"
            + "\b1) Giữ ngọc sao đen trên người hơn 5 phút liên tục"
            + "\b2) Sau 30 phút tham gia tàu sẽ đón về và đang giữ ngọc sao đen trên người\n"
            + "Các phần thưởng như sau"
            + "\b1 sao đen: +15% sức đánh cho toàn bang"
            + "\b2 sao đen: +20% HP và KI tối đa cho toàn bang"
            + "\b3 sao đen: Mỗi giờ cho 10 hạt đậu thần cấp 8 cho toàn bang"
            + "\b4 sao đen: Mỗi giờ 1 bùa 1h ngẫu nhiên cho toàn bang"
            + "\b5 sao đen: Mỗi giờ 3 ngọc nâng cấp ngẫu nhiên cho toàn bang"
            + "\b6 sao đen: Mỗi giờ cho 200.000 vàng cho toàn bang"
            + "\b7 sao đen: Mỗi giờ 2 ngọc cho toàn bang"
            + "\b Các phần thưởng mỗi giờ đến ta để nhận nhé";
    ...
    public static final byte KING_FURY = 76;
    
    public static final byte LY_TIEU_NUONG_1 = 78;
    ...
    public static final int MENU_OPEN_KGHD = 500;
    public static final int MENU_OPENED_KGHD = 501;
    public static final int MENU_ACCEPT_GO_TO_KGHD = 502;
    
    public static final int MENU_NANG_CAP_TS = 502;
    ...
    public static final int TAIXIU = 501232323;
    public static final int MENU_NOI_CHUYEN = 503;
    public static final int MENU_DUA_TOP = 504;

    public static final int ACP_GIAI_TAN_BANG = 505;
    ...
    public static final int CALL_BOSS = 19062000;

    public static final int SACH_TUYET_KY = 507;

    public static final int DONG_THANH_SACH_CU = 508;

    public static final int DOI_SACH_TUYET_KY = 509;

    public static final int DONG_THANH_SACH_CU_2 = 510;

    public static final int DOI_SACH_TUYET_KY_2 = 511;

    public static final int CHUC_NANG_SAO_PHA_LE = 512;

    public static final int CHUYEN_HOA_TRANG_BI = 513;

    public static final int NHAN_QUA_VO_DAI = 514;

    public static final int DAI_HOI_VO_THUAT = 515;

    public static final int DANG_KY_DAI_HOI_VO_THUAT = 516;
    ...
    public static final int HOP_QUA_THAN_LINH = 1000;

    //index whis
    public static final int HIEN_TE_SU_PHU = 1001;

    public static final int HIEN_TE_DE_TU = 1002;

    public static final int HOC_TUYET_KY = 1003;

    public static final int HOC_TUYET_KY_2 = 1004;

    //index 3 ông già
    public static final int MENU_NAP_TIEN = 1005;

    public static final int MENU_DOI_VANG = 1006;

    public static final int MENU_DOI_NGOC = 1007;

    public static final int MENU_NHAN_RUONG = 1008;

    public static final int MENU_MO_THANH_VIEN = 1009;
    ...
    public static final int SHOP_SANTA_4 = 150492;
    public static final int SHOP_URON_0 = 505;
    public static final int SHOP_DA = 509817;
    ...
    public static final int SHOP_TORIBOT_2 = 520;
    public static final int SHOP_LEARN_SKILL = 51729;

    public static final int SHOP_SANTA_3 = 519;

    // thần mèo
    public static final int THACH_DAU_THAN_MEO = 0;

    public static final int THACH_DAU_YAJIRO = 1;

    public static final int COFIRM_THACH_DAU_THAN_MEO = 2;

    public static final int COFIRM_THACH_DAU_YAJIRO = 3;

    public static final int COFIRM_LUYEN_TAP_THAN_MEO = 4;

    public static final int COFIRM_LUYEN_TAP_YAJIRO = 5;

    // Thuong De
    public static final int THACH_DAU_POPO = 0;
    public static final int THACH_DAU_THUONG_DE = 1;
