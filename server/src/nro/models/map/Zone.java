...
//                msg.writer().writeShort(0);
            try {
                byte[] bgItem = FileIO.readFile("resources/data_game/map/item_bg_map_data/" + this.map.mapId);
...
//            msg.writer().writeShort(0);
            try {
                byte[] effItem = FileIO.readFile("resources/data_game/map/eff_map/" + this.map.mapId);
