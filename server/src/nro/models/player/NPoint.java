...
//        }
    ...
    private void setHpMax() {
        ...
        if (this.player.setClothes.nappa == 5) {
            this.hpMax += calPercent(this.hpMax, this.player.setClothes.tilenappa);
        }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isUseBoHuyet2) {
            this.hpMax += calPercent(hpMax, 100);
        }
    ...
    private void setMpMax() {
        ...
        if (this.player.setClothes.picolo == 5) {
              this.mpMax += calPercent(this.mpMax, this.player.setClothes.tilepicolo);
      }
        //ngọc rồng đen 3 sao
        ...
        if (this.player.itemTime != null && this.player.itemTime.isUseBoKhi2) {
            this.mpMax += calPercent(mpMax, 100);
        }
        //phù
        if (this.player.zone != null && MapService.gI().isMapBlackBallWar(this.player.zone.map.mapId)) {
...
//                }
            ...
            case Skill.QUA_CAU_KENH_KHI:
                ...
                if (this.player.setClothes.kirin == 5) {
                    damage += damage*this.player.setClothes.tilekirin;
                }
                return damage;
        }
