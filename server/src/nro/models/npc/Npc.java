            ...
            try {
                if (baseMenu != null) {
                    ...
                    if(this.mapId == 5 || this.mapId == 13 || this.mapId == 20){
                         NpcService.gI().createTutorial(player, this.avartar, "Con hãy về hành tinh của mình mà thể hiện");
                    }else{
                       NpcService.gI().createTutorial(player, this.avartar, "Chức năng đang được phát triển [" + this.tempId + "][" + this.mapId + "]"); 
                    }
