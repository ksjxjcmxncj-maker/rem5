 ...
 * @copyright 💖 GirlkuN 💖
 */
public class Boss_Kingkai extends FutureBoss {

    public Boss_Kingkai(int bossID, BossData bossData, Zone zone, int x, int y, int id_player) throws Exception {
