    ...
    public void rewards(Player pl) {
        ...
        if (tempId != -1) {
            ...
            if (tempId >= 2027 && tempId <= 2038) {
                ...
                itemMap.options.add(new ItemOption(77, Util.nextInt(10, 20)));
                itemMap.options.add(new ItemOption(103, Util.nextInt(10, 20)));
                itemMap.options.add(new ItemOption(50, Util.nextInt(10, 20)));
