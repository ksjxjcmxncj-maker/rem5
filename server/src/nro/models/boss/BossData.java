...
public class BossData {
    ...
    public static final BossData TAU_7_7 = new BossData(
            ...
            new short[]{}, //map join
            new int[][]{ //skill
                {Skill.DRAGON, 1, 1000}, {Skill.DRAGON, 2, 2000}, {Skill.DRAGON, 3, 3000}, {Skill.DRAGON, 7, 7000}, {Skill.KAMEJOKO, 7, 2000}, {Skill.KAMEJOKO, 6, 1800}, {Skill.KAMEJOKO, 4, 1500}, {Skill.KAMEJOKO, 2, 1000}},
            _0_GIAY
    );
    ...
    public static final BossData BUBBLES = new BossData(
            "Bubbles", //name
            ConstPlayer.XAYDA, //gender
            Boss.DAME_NORMAL, //type dame
            Boss.HP_NORMAL, //type hp
   ...
   public static final BossData KINGKAI = new BossData(
            "Thần Vũ Trụ", //name
            ConstPlayer.XAYDA, //gender
            Boss.DAME_NORMAL, //type dame
            Boss.HP_NORMAL, //type hp
...
//    
    ...
    public static final BossData CUMBER = BossData.builder()
            ...
            .outfit(new short[]{1396, 1395, 1394})
    ...
    public static final BossData CUMBER2 = BossData.builder()
            ...
            .dame(500000)
            .hp(new int[][]{{2000000000}})
            .outfit(new short[]{1397, 1395, 1394})
            .mapJoin(new short[]{155})
            .skillTemp(new int[][]{
        {Skill.DRAGON, 1, 100}, {Skill.DRAGON, 2, 200}, {Skill.DRAGON, 3, 300}, {Skill.DRAGON, 7, 700},
        {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700},
