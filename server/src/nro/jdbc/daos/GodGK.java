            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    if (!String.valueOf(dataObject).equals("{}")) {
                        ...
                        pet.isGokuSSJ4 = Byte.parseByte(String.valueOf(dataObject.get("is_GokuSSJ4"))) == 1;
                        pet.isVegetaSSJ4 = Byte.parseByte(String.valueOf(dataObject.get("is_VegetaSSJ4"))) == 1;
                        pet.isBabyFide = Byte.parseByte(String.valueOf(dataObject.get("is_BabyFide"))) == 1;
                        pet.isBabyKidbu = Byte.parseByte(String.valueOf(dataObject.get("is_BabyKidbu"))) == 1;
                        pet.isBabyCell = Byte.parseByte(String.valueOf(dataObject.get("is_BabyCell"))) == 1;
